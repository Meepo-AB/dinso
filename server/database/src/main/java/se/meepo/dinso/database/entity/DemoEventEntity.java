...
public class DemoEventEntity {
  ...
  public DemoEventEntity(CustomerId customerId, Instant occurredAt, String eventType, String summary) { this.customerId = customerId; this.occurredAt = occurredAt; this.eventType = eventType; this.summary = summary; }
}
