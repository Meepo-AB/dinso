...
public class CustomerRuleProperties {
  ...
  public CustomerRules toRules() {
    return new CustomerRules(
        portals,
        locales,
        defaultLocale,
        maximumFunds,
        ...
        showFees,
        showTransactions,
        showTraditionalBonusRate,
        companyMutations);
  }

  public Set<PortalType> getPortals() {
    return portals;
  }

  public void setPortals(Set<PortalType> portals) {
  ...
  public void setMaximumFunds(int maximumFunds) {
    this.maximumFunds = maximumFunds;
  }

  public int getMaximumLeaveMonths() {
    return maximumLeaveMonths;
  }

  public void setMaximumLeaveMonths(int maximumLeaveMonths) {
    this.maximumLeaveMonths = maximumLeaveMonths;
  }

  public Set<LeaveReason> getLeaveReasons() {
    return leaveReasons;
  }

  public void setLeaveReasons(Set<LeaveReason> leaveReasons) {
  ...
  public boolean isShowTraditionalBonusRate() {
    return showTraditionalBonusRate;
  }

  public void setShowTraditionalBonusRate(boolean showTraditionalBonusRate) {
    this.showTraditionalBonusRate = showTraditionalBonusRate;
  }

  public Set<CompanyMutation> getCompanyMutations() {
    return companyMutations;
  }

  public void setCompanyMutations(Set<CompanyMutation> companyMutations) {
    this.companyMutations = companyMutations;
  }
}
